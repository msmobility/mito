...
public final class MitoModel2 {
    ...
    private MitoModel2(DataSetImpl dataSet, String scenarioName) {
    ...
    public static MitoModel2 initializeModelFromSilo(String propertiesFile, DataSetImpl dataSet, String scenarioName) {
