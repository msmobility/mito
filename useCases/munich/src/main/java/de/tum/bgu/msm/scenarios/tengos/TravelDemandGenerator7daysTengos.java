...
import static de.tum.bgu.msm.data.Purpose.getAllPurposes;
 ...
 */
public final class TravelDemandGenerator7daysTengos {

    private static final Logger logger = Logger.getLogger(TravelDemandGenerator7daysTengos.class);
    ...
    private TravelDemandGenerator7daysTengos(
            DataSet dataSet,
    ...
    public static class Builder {
        ...
        public Builder(DataSet dataSet) {
            ...
            mandatoryPurposes.forEach(purpose -> ((TripGeneration) tripGenerationMandatory).registerTripGenerator(purpose, new MitoTripFactoryTengos(), TripGeneratorType.PersonBasedHurdlePolr,new TripGenCalculator7days(dataSet),new AttractionCalculatorImpl(dataSet,purpose)));
            ...
            discretionaryPurposes.forEach(purpose -> ((TripGeneration) tripGenerationDiscretionary).registerTripGenerator(purpose, new MitoTripFactoryTengos(),TripGeneratorType.PersonBasedHurdleNegBin,new TripGenCalculator7days(dataSet),new AttractionCalculatorImpl(dataSet,purpose)));
        ...
        public TravelDemandGenerator7daysTengos build() {
            return new TravelDemandGenerator7daysTengos(dataSet,
