...
import de.tum.bgu.msm.MitoModelAggregate;
...
public class MitoAggregate {

    private static final Logger logger = Logger.getLogger(MitoAggregate.class);

    public static void main(String[] args) {
        logger.info("Started the Microsimulation Transport Orchestrator (MITO) based on 2017 models");
        MitoModelAggregate model = MitoModelAggregate.standAloneModel(args[0], MunichImplementationConfig.get());
        model.run();
