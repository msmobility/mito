...
import de.tum.bgu.msm.modules.tripDistribution.TripDistributionCalibrationSanFrancisco;
 ...
 * - sizeOfZonesInAcre
 */
public final class CalibrateDestinationChoiceSanFrancisco {

    private static final Logger logger = Logger.getLogger(CalibrateDestinationChoiceSanFrancisco.class);
    private final String scenarioName;

    private DataSet dataSet;

    public static void main(String[] args) {
        CalibrateDestinationChoiceSanFrancisco model = CalibrateDestinationChoiceSanFrancisco.standAloneModel(args[0], SanFranciscoImplementationConfig.get());
        model.run();
    }

    private CalibrateDestinationChoiceSanFrancisco(DataSet dataSet, String scenarioName) {
        this.dataSet = dataSet;
        this.scenarioName = scenarioName;
        MitoUtil.initializeRandomNumber();
    }

    public static CalibrateDestinationChoiceSanFrancisco standAloneModel(String propertiesFile, ImplementationConfig config) {
        logger.info(" Creating standalone version of MITO ");
        Resources.initializeResources(propertiesFile);
        CalibrateDestinationChoiceSanFrancisco model = new CalibrateDestinationChoiceSanFrancisco(new DataSet(), Resources.instance.getScenarioName());
        model.readStandAlone(config);
        return model;
    }

    public static CalibrateDestinationChoiceSanFrancisco initializeModelFromSilo(String propertiesFile, DataSet dataSet, String scenarioName) {
        logger.info(" Initializing MITO from SILO");
        Resources.initializeResources(propertiesFile);
        CalibrateDestinationChoiceSanFrancisco model = new CalibrateDestinationChoiceSanFrancisco(dataSet, scenarioName);
    ...
    public void run() {
        ...
        TripDistributionCalibrationSanFrancisco tripDistributionCalibrationMandatory =
                new TripDistributionCalibrationSanFrancisco(dataSet, Purpose.getMandatoryPurposes(),
        ...
        TripDistributionCalibrationSanFrancisco tripDistributionCalibrationDiscretionary =
                new TripDistributionCalibrationSanFrancisco(dataSet, Purpose.getDiscretionaryPurposes(),
