...
import de.tum.bgu.msm.modules.tripDistribution.DestinationUtilityCalculatorFactoryImplSanFrancisco;
 ...
 * - sizeOfZonesInAcre
 */
public final class MitoModelSanFranciscoForModeChoiceCalibration {

    private static final Logger logger = Logger.getLogger(MitoModelSanFranciscoForModeChoiceCalibration.class);
    private final String scenarioName;

    private DataSet dataSet;

    private MitoModelSanFranciscoForModeChoiceCalibration(DataSet dataSet, String scenarioName) {
        this.dataSet = dataSet;
        this.scenarioName = scenarioName;
        MitoUtil.initializeRandomNumber();
    }

    public static MitoModelSanFranciscoForModeChoiceCalibration standAloneModel(String propertiesFile, ImplementationConfig config) {
        logger.info(" Creating standalone version of MITO ");
        Resources.initializeResources(propertiesFile);
        MitoModelSanFranciscoForModeChoiceCalibration model = new MitoModelSanFranciscoForModeChoiceCalibration(new DataSet(), Resources.instance.getScenarioName());
    ...
    private void runForThisPurposes(List<Purpose> purposes) {
        ...
        TripDistribution distribution = new TripDistribution(dataSet, purposes, false, new DestinationUtilityCalculatorFactoryImplSanFrancisco());
        distribution.run();
