...
import de.tum.bgu.msm.OpenMitoModel;
...
public class OpenMito {

    private static final Logger logger = Logger.getLogger(OpenMito.class);

    public static void main(String[] args) {
        logger.info("Started the Microsimulation Transport Orchestrator (MITO) based on 2017 models");
        OpenMitoModel model = OpenMitoModel.standAloneModel(args[0], MunichImplementationConfig.get());
        model.run();
