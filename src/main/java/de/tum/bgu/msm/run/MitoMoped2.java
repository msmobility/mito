...
public class MitoMoped2 {
    ...
    public static void main(String[] args) {
        ...
        MitoMopedModel2 model = MitoMopedModel2.standAloneModel(args[0], MunichImplementationConfig.get());
        model.run();
        ...
        Config carConfig = ConfigUtils.loadConfig(config.getContext());
        ...
        Config bikePedConfig = ConfigUtils.loadConfig(config.getContext());
        ...
        /*if (runAssignment) {
            ...
            String outputSubDirectory = "scenOutput/" + model.getScenarioName() + "/" + dataSet.getYear();
            config.controler().setOutputDirectory(Resources.instance.getBaseDirectory().toString() + "/" + outputSubDirectory + "/trafficAssignment/Car");
        ...
        if (runBikePedAssignment) {
            ...
            String outputSubDirectory = "scenOutput/" + model.getScenarioName() + "/" + dataSet.getYear();
            config.controler().setOutputDirectory(Resources.instance.getBaseDirectory().toString() + "/" + outputSubDirectory + "/trafficAssignment/BikePed");
            ...
            logger.warn("Running MATSim transport model for Bike&Ped scenario.");
            config.network().setInputFile("input/trafficAssignment/studyNetworkDenseBikeWalkHealth.xml.gz");
            MutableScenario scenarioBikePed = (MutableScenario) ScenarioUtils.loadScenario(config);
            scenarioBikePed.setPopulation(populationBikePed);
