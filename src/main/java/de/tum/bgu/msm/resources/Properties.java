...
public class Properties {
    ...
    public static final String TRIP_DISTRIBUTION_UEC_FILE = "trip.distribution.UEC.file";
    public static final String TRIP_DISTRIBUTION_UEC_DATA_SHEET = "trip.distribution.UEC.DataSheetNumber";
    public static final String HBW_TRIP_DISTRIBUTION_UEC_SHEET = "trip.distribution.UEC.Utility";
    public static final String HBE_TRIP_DISTRIBUTION_UEC_SHEET = "trip.distribution.UEC.Utility";
    public static final String HBS_TRIP_DISTRIBUTION_UEC_SHEET = "trip.distribution.UEC.Utility";
    public static final String HBO_TRIP_DISTRIBUTION_UEC_SHEET = "trip.distribution.UEC.Utility";
    public static final String NHBW_TRIP_DISTRIBUTION_UEC_SHEET = "trip.distribution.UEC.Utility";
    public static final String NHBO_TRIP_DISTRIBUTION_UEC_SHEET = "trip.distribution.UEC.Utility";
    public static final String NHBW_ALT_TRIP_DISTRIBUTION_UEC_SHEET = "trip.distribution.UEC.Utility";
    public static final String NHBO_ALT_TRIP_DISTRIBUTION_UEC_SHEET = "trip.distribution.UEC:Utility";
