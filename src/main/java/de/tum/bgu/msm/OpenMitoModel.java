 ...
 * - sizeOfZonesInAcre
 */
public final class OpenMitoModel {

    private static final Logger logger = Logger.getLogger(OpenMitoModel.class);
    private final String scenarioName;

    private DataSet dataSet;

    private OpenMitoModel(DataSet dataSet, String scenarioName) {
    ...
    public static OpenMitoModel initializeModelFromSilo(String propertiesFile, DataSet dataSet, String scenarioName) {
        logger.info(" Initializing MITO from SILO");
        Resources.initializeResources(propertiesFile);
        OpenMitoModel model = new OpenMitoModel(dataSet, scenarioName);
    ...
    public void run() {
        ...
        OpenTravelDemandGenerator ttd = new OpenTravelDemandGenerator.Builder(dataSet).build();
