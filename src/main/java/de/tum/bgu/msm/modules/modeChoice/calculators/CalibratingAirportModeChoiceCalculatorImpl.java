...
public class CalibratingAirportModeChoiceCalculatorImpl extends AirportModeChoiceCalculator {

    private final ModeChoiceCalculator base;
    private final ModeChoiceCalibrationData calibrationData;

    public CalibratingAirportModeChoiceCalculatorImpl(ModeChoiceCalculator base, ModeChoiceCalibrationData calibrationData) {
        super();
        this.base = base;
