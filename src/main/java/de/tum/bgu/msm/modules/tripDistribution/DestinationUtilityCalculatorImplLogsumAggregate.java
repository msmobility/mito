...
public class DestinationUtilityCalculatorImplLogsumAggregate implements DestinationUtilityCalculatorAggregate {
    ...
    DestinationUtilityCalculatorImplLogsumAggregate(Purpose purpose, double logsumCalibrationK, double distanceCalibrationK) {
        switch (purpose) {
            case HBW:
