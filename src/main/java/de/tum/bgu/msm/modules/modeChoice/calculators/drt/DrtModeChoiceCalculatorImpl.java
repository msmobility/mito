package de.tum.bgu.msm.modules.modeChoice.calculators.drt;
...
public class DrtModeChoiceCalculatorImpl implements ModeChoiceCalculator {

    private ModeChoiceCalculator baseCalculator;

    @Override
    public double[] calculateProbabilities(Purpose purpose, MitoHousehold household, MitoPerson person, MitoZone originZone, MitoZone destinationZone, TravelTimes travelTimes, double travelDistanceAuto, double travelDistanceNMT, double peakHour_s) {
        return new double[0];
    }
