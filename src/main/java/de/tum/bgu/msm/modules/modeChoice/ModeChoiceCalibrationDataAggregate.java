...
public class ModeChoiceCalibrationDataAggregate {
    ...
    private static Logger logger = Logger.getLogger(ModeChoiceCalibrationDataAggregate.class);

    public ModeChoiceCalibrationDataAggregate() {
