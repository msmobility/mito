 ...
 * @author Nico
 */
public final class HbeHbwDistributionLogsum extends RandomizableConcurrentFunction<Void> {
    ...
    private HbeHbwDistributionLogsum(Purpose purpose, MitoOccupationStatus mitoOccupationStatus,
    ...
    public static HbeHbwDistributionLogsum hbe(IndexedDoubleMatrix2D baseProbabilitiesEV, IndexedDoubleMatrix2D baseProbabilitiesNoEV, Collection<MitoHousehold> householdPartition, Map<Integer, MitoZone> zones) {
        return new HbeHbwDistributionLogsum(Purpose.HBE, MitoOccupationStatus.STUDENT, baseProbabilitiesEV, baseProbabilitiesNoEV, householdPartition, zones);
    }

    public static HbeHbwDistributionLogsum hbw(IndexedDoubleMatrix2D baseProbabilitiesEV, IndexedDoubleMatrix2D baseProbabilitiesNoEV, Collection<MitoHousehold> householdPartition, Map<Integer, MitoZone> zones) {
        return new HbeHbwDistributionLogsum(Purpose.HBW, MitoOccupationStatus.WORKER, baseProbabilitiesEV, baseProbabilitiesNoEV, householdPartition, zones);
    }
    ...
    private void findDestination(MitoHousehold household, MitoTrip trip) {
        ...
        if (isFixedByOccupation(trip)) {
            ...
            TripDistributionLogsumEVnoEV.randomOccupationDestinationTrips.incrementAndGet();
