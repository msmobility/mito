...
public class TripsByPurposeGeneratorPersonBasedHurdleAggregateModel extends RandomizableConcurrentFunction<Tuple<Purpose, Map<MitoHousehold, List<MitoTrip>>>> implements TripsByPurposeGenerator {
