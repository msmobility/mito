...
public class TrafficAssignment extends Module {
    ...
    private final MitoMatsimTravelTimes mitoMatsimTravelTimes = new MitoMatsimTravelTimes();
...
//        populationWriter.write(outputDirectory + "population.xml");
    ...
    private void runMatsim() {
        ...
        mitoMatsimTravelTimes.updateTravelTimesFromMatsim(leastCoastPathTree, zoneFeatureMap, matsimScenario.getNetwork(), controler.getTripRouterProvider().get() );
