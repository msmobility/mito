...
public class ModeChoiceCalculatorImplLogsum implements ModeChoiceCalculatorLogsum {

    private static final double SPEED_WALK_KMH = 4;
    private static final double SPEED_BICYCLE_KMH = 10;

    public EnumMap<Mode, Double> calculateProbabilities(Purpose purpose,
    ...
    public EnumMap<Mode, Double> calculateUtilities(Purpose purpose, MitoHousehold household, MitoPerson person,
                                                    MitoZone originZone, MitoZone destinationZone, TravelTimes travelTimes,
...
//        int isMunichTrip = originZone.isMunichZone() ? 1 : 0;
    ...
    public EnumMap<Mode, Double> calculateGeneralizedCosts(
            Purpose purpose, MitoHousehold household, MitoPerson person, MitoZone originZone, MitoZone destinationZone,
            TravelTimes travelTimes, double travelDistanceAuto, double travelDistanceNMT, double peakHour_s, Map<Mode, Map<String, Double>> coef) {
