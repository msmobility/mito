...
public class ModeChoiceLogsum extends Module {

    private final static Logger logger = Logger.getLogger(ModeChoiceLogsum.class);

    private final Map<Purpose, ModeChoiceCalculatorLogsum> modeChoiceCalculatorByPurpose = new EnumMap<>(Purpose.class);

    public ModeChoiceLogsum(DataSet dataSet, List<Purpose> purposes) {
