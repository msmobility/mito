...
public class DataSet {
    ...
    private Map<Integer, UAMStation> zoneIdToStationMap;
    ...
    public void setZoneIdToStationMap(Map<Integer, UAMStation> zoneIdToStationMap) {
        this.zoneIdToStationMap = zoneIdToStationMap;
    }
