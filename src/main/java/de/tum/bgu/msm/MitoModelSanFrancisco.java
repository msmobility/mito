 ...
 * - sizeOfZonesInAcre
 */
public final class MitoModelSanFrancisco {

    private static final Logger logger = Logger.getLogger(MitoModelSanFrancisco.class);
    private final String scenarioName;

    private DataSet dataSet;

    private MitoModelSanFrancisco(DataSet dataSet, String scenarioName) {
        this.dataSet = dataSet;
        this.scenarioName = scenarioName;
        MitoUtil.initializeRandomNumber();
    }

    public static MitoModelSanFrancisco standAloneModel(String propertiesFile, ImplementationConfig config) {
        logger.info(" Creating standalone version of MITO ");
        Resources.initializeResources(propertiesFile);
        MitoModelSanFrancisco model = new MitoModelSanFrancisco(new DataSet(), Resources.instance.getScenarioName());
        model.readStandAlone(config);
        return model;
    }

    public static MitoModelSanFrancisco initializeModelFromSilo(String propertiesFile, DataSet dataSet, String scenarioName) {
        logger.info(" Initializing MITO from SILO");
        Resources.initializeResources(propertiesFile);
        MitoModelSanFrancisco model = new MitoModelSanFrancisco(dataSet, scenarioName);
    ...
    public void run() {
        ...
        TravelDemandGeneratorSanFrancisco ttd = new TravelDemandGeneratorSanFrancisco.Builder(dataSet).build();
