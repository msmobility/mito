 ...
 */
public final class TravelDemandGeneratorSanFrancisco {

    private static final Logger logger = Logger.getLogger(TravelDemandGeneratorSanFrancisco.class);
    ...
    private TravelDemandGeneratorSanFrancisco(
            DataSet dataSet,
    ...
    public static class Builder {
        ...
        public Builder(DataSet dataSet) {
            ...
            distributionMandatory = new TripDistribution(dataSet, Purpose.getMandatoryPurposes(), false,
                    new DestinationUtilityCalculatorFactoryImplSanFrancisco());
        ...
        public TravelDemandGeneratorSanFrancisco build() {
            return new TravelDemandGeneratorSanFrancisco(dataSet,
