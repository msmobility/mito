...
public class SummarizeData {
    ...
    public static void writeOutSyntheticPopulationWithTrips(DataSet dataSet) {
        ...
        for (MitoHousehold hh : dataSet.getHouseholds().values()) {
            ...
            pwh.print(",");
            pwh.println(getTotalNumberOfTripsGeneratedByPurposeByHousehold(0, hh, dataSet.getTrips().values()));
        }
        pwh.close();
    ...
    private static int getTotalNumberOfTripsGeneratedByPurposeByHousehold(int purpose, MitoHousehold hh, Collection<MitoTrip> trips) {
