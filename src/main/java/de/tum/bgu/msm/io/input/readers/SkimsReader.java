...
public class SkimsReader extends AbstractOmxReader {
    ...
    public void readOnlyTransitTravelTimes(){
        ...
        skimTravelTimes.readSkim("bus", Resources.instance.getRelativePath(Properties.BUS_TRAVEL_TIME_SKIM).toString(), "mat1", 1.);
        skimTravelTimes.readSkim("tramMetro", Resources.instance.getRelativePath(Properties.TRAM_METRO_TRAVEL_TIME_SKIM).toString(), "mat1", 1.);
        skimTravelTimes.readSkim("train", Resources.instance.getRelativePath(Properties.TRAIN_TRAVEL_TIME_SKIM).toString(), "mat1", 1.);
    }
