 ...
 */
public final class OpenTravelDemandGenerator {

    private static final Logger logger = Logger.getLogger(OpenTravelDemandGenerator.class);
    ...
    private OpenTravelDemandGenerator(
            DataSet dataSet,
    ...
    public static class Builder {
        ...
        public OpenTravelDemandGenerator build() {
            return new OpenTravelDemandGenerator(dataSet,
